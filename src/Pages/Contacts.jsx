...
import exampleImage from "./Design.jpg"
...
const Contacts = () => {
    ...
    return (
        <div className="w-full h-screen bg-cover bg-center pt-8" style={{ backgroundImage: `url(${exampleImage})`}}>
        <div className="justify-center pt-16 text-gray-50   p-4  w-full" >
            <div className="m-4">
                <button className="rounded-md bg-blue-900 p-2 text-2xl">
            ...
            {AllContacts.length == 0 && <div className=" m-auto w-fit p-4 align-middle text-blue-500 justify-center">
                ...
                <h1 className="text-3xl text-blue-900 pt-40">No Contact Found!!! <br />Please add contact using <br /> Create Contact button</h1>
            </div>}
                    ...
                    AllContacts.map((el) => {
                        return <div key={el.id} className="bg-blue-950 rounded-lg shadow-md m-4 p-4 text-white">
                            ...
                            <div className="flex justify-between my-2">
                                <Link to={`edit/${el.id}`}>
                                    <button className="rounded p-2 bg-green-500 text-white text-black">
